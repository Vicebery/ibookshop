...
<body>
		...
		<div class="span9">
			<div class="headerAd">
				<img src="${pageContext.request.contextPath}/image/header.jpg"
					width="320" height="50" alt="学海无涯" title="学海无涯" />
			</div>
		</div>
	...
	<div class="container footer">
		<div class="span24">
			<div class="footerAd">
				<img src="image/footer.jpg" alt="学海无涯"
					title="学海无涯" height="52" width="950">
			</div>
		</div>
		<div class="span24">
			<ul class="bottomNav">
				<li><a href="http://www.vicebery.cc/">关于我们</a> |</li>
				<li><a href="mailto:Vicebery@163.com">联系我们</a> |</li>
				<li><a href="#">诚聘英才</a> |</li>
				<li><a href="#">法律声明</a> |</li>
				<li><a>友情链接</a> |</li>
