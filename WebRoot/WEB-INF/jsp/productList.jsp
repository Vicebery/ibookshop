...
<div class="container header">
	...
	<div class="span9">
<div class="headerAd">
					<img src="${pageContext.request.contextPath}/image/header.jpg" width="320" height="50" alt="学海无涯" title="学海无涯"></img>
</div>	</div>
...
<div class="container productList">
		...
		<div class="span18 last">
			...
			<form id="productForm"  method="get">
				...
				<div id="result" class="result table clearfix" style="margin-top:10px;">
						<ul>
							<s:iterator var="p" value="pageBean.list">
								<li>
										<a href="${ pageContext.request.contextPath }/product_findByPid.action?pid=<s:property value="#p.pid"/>">
											<img src="${pageContext.request.contextPath}/<s:property value="#p.image"/>" width="120" height="170"  style="display: inline-block;margin:0 25px;"></img>
