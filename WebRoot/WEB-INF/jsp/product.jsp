...
<div class="container header">
	...
	<div class="span9">
<div class="headerAd">
					<img src="image/header.jpg" alt="学海无涯" title="学海无涯" height="50" width="320">
</div>	</div>
		...
		<div class="span18 last">
			...
			<div class="productImage">
					<a title="" style="outline-style: none; text-decoration: none;" id="zoom" rel="gallery">
						<div class="zoomPad">
							<img style="opacity: 1;" title="" class="medium" src="${ pageContext.request.contextPath }/<s:property value="model.image"/>"></img>
						</div>
					</a>
				
			</div>
			<div class="name" style="margin-top:10px;"><s:property value="model.pname"/></div>
			<div class="sn">
			...
			<div class="info">
				<dl>
					...
					<dl>
						<dt>促销:</dt>
						<dd>
								<a target="_blank" title="限时抢购 (2016-12-25 ~ 2017-01-03)">限时抢购</a>
						</dd>
					</dl>
					<dl>
						<dt>    </dt>
...
<div class="container footer">
	<div class="span24">
		<div class="footerAd">
					<img src="image/footer.jpg" alt="智慧的力量" title="智慧的力量" height="52" width="950">
</div>
</div>
	<div class="span24">
		<ul class="bottomNav">
